    ...
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 pb-6">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li>
                        <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href="{{ route('admin.roles.show', $role) }}">
        ...
        <form method="POST" action="{{ route('admin.roles.update', $role) }}" class="space-y-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="border-b border-gray-200 px-5 py-4 sm:px-6 sm:py-5 dark:border-gray-800">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Update nama dan identitas role
                    </p>
                </div>
                ...
                <div class="p-5 sm:p-6">
                    <div>
                        ...
                        <input 
                            ...
                            required
                            placeholder="Contoh: event_manager"
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                        />
                        <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Gunakan underscore (_) untuk pemisah kata, contoh: event_manager</p>
                        @error('name')
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('admin.roles.show', $role) }}" class="shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]">
                    Batal
                </a>
