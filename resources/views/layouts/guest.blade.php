...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Assets -->
        <link rel="icon" type="image/png" href="https://api.tka24.my.id/storage/img/simekv2-ico.png">
                    ...
                    <div class="flex items-center justify-center z-1">
                        <div class="flex flex-col items-center max-w-xs">
                            <a href="/" class="block mb-4">
                                <img src="{{ asset('assets/img/simekv2-icf.png') }}" style="width: 180px; height: 60px;" alt="Logo" />
                            </a>
                        </div>
                    </div>
                </div>
