  ...
  >
    ...
    >
      ...
      <a href="{{ route('dashboard') }}" class="lg:hidden">
        <img class="dark:hidden" src="{{ asset('assets/img/simekv2-icf.png') }}" style="width: 120px; height: 40px;" alt="Logo" />
        <img
          class="hidden dark:block"
          src="{{ asset('assets/img/simekv2-icf.png') }}" style="width: 120px; height: 40px;" 
          alt="Logo"
        />
      </a>
    ...
    >
      ...
      >
        ...
        <span class="text-theme-sm ml-3 block font-medium"> 
          {{ Auth::user()->name }} 
        </span>
